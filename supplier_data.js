...
const gnfs_1 = makeSupplierData(
  ...
  [
    ...
    50, 51, 52, 22, 53, 29, 54, 55, 99, 98, 57, 56,
  ]
);
...
const gnfs_3 = makeSupplierData(
  data,
  [
    31, 59, 60, 61, 30, 204, 36, 63, 33, 64, 65, 66, 67, 68, 69, 62, 21, 28, 70, 71,
    34, 72, 73, 75, 76, 74,
  ]
);
...
const gnfs_4 = makeSupplierData(
  data,
  [
    37, 77, 42, 35, 38, 39, 40, 41, 58, 78, 106, 79, 80, 81, 82, 83, 43, 84, 85, 86,
...
const gnfs_7 = makeSupplierData(data, [104, 105, 23, 24, 25, 14, 15, 16, 19, 107, 113]);
